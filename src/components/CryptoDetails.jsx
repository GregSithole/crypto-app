    ...
    return (
        <Col className="coin-detail-container">
            <Col className="coin-heading-container">
                ...
                <p>
                    {cryptoDetails.name} live price in US Dollars. View value statistics, market cap and suppky
                </p>
            </Col>
            <Select
                defaultValue="7d"
            ...
            <Col className="coin-desc-link">
                ...
                <Col className="coin-links">
                    <Title className="coin-details-heading" level={3}>{cryptoDetails.name} Links</Title>
